...
import { mutePlanItemSchema } from "../../schemas/plan/mutePlanItem.schema";
import { mutePlanItem } from "../../services/plan/planItem.service";
  ...
  requireRole("owner")(
    async (event, auth): Promise<APIGatewayProxyResult> => {
      ...
      return sendSuccessResponse(
        await mutePlanItem(requester, vehicleId, planItemId, payload),
      );
    },
  ),
);
